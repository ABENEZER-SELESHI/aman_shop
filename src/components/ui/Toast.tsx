        ...
        {items.map((item) => (
          <div
            ...
            className={cn(
              ...
              item.tone === "success" && "border-[var(--accent-soft)] bg-[var(--surface)] text-[var(--ink)]",
              item.tone === "error" && "border-red-200 bg-[var(--surface)] text-red-800",
              item.tone === "info" && "border-[var(--border)] bg-[var(--surface)] text-[var(--ink)]",
            )}
            role="status"
          >
            {item.message}
